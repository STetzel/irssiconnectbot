...
public class HostDatabase extends RobustSQLiteOpenHelper {
	...
	public final static String FIELD_HOST_PROXY_ENABLE = "http_proxy_enable";
	public final static String FIELD_HOST_PROXY_HOST = "http_proxy_host";
	public final static String FIELD_HOST_PROXY_PORT = "http_proxy_port";
	...
	private List<HostBean> createHostBeans(Cursor c) {
		...
		while (c.moveToNext()) {
			...
			host.setProxyEnable(Boolean.valueOf(c.getString(COL_PROXY_ENABLE)));
			host.setProxyHost(c.getString(COL_PROXY_HOST));
			host.setProxyPort(c.getInt(COL_PROXY_PORT));
